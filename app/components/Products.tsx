  ...
  return (
    <section id="products" className="py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Using background color and gap to create uniform orange dividers */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-[#ff5e14] border-y border-[#ff5e14]">
          {products.map((p, idx) => (
            <div key={idx} className="bg-white p-12 hover:bg-gray-50 transition-all duration-300 group cursor-pointer relative overflow-hidden">
