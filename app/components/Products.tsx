  ...
  return (
    <section id="products" className="py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-[#00b4cc] border-y border-[#00b4cc]">
          {products.map((p, idx) => (
            <ScrollReveal key={idx}>
              <div className="bg-white p-12 hover:bg-gray-50 transition-all duration-300 group cursor-pointer relative overflow-hidden h-full">
                ...
                <div className="absolute top-0 left-0 w-full h-1 bg-[#00b4cc] transform -translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                
                <span className="block text-[10px] font-black text-gray-400 tracking-[0.2em] mb-4 group-hover:text-[#00b4cc] transition-colors uppercase">
                  {p.subtitle}
                </span>
                <h3 className="text-xl font-black text-[#002147] mb-8 uppercase tracking-tight">
                  {p.title}
                </h3>
                <div className="text-[#00b4cc] text-3xl font-light group-hover:scale-125 transition-transform inline-block">
                  +
                </div>
              </div>
            </ScrollReveal>
